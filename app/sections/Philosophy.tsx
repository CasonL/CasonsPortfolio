...
const principles = [
  {
    ...
    hook: "I research before I build.",
    body: "60+ customer discovery interviews before writing a line of code. That research decided which models to use, what to cut, and where the feedback loops live.",
  ...
  },
  {
    ...
    body: "PitchIQ orchestrates specialized models for scenario generation, persona simulation, and real-time coaching, all in parallel. No single expensive model. Just a system that feels like a senior sales coach.",
  ...
  },
  {
    ...
    body: "I grew MacEwan Speechleaders from 20 to 90+ members in two weeks by designing something worth returning to. Same principle ran my painting franchise: knowing whose energy goes where.",
  ...
  },
  {
    ...
    body: "Built PitchIQ from zero to launch while running a $42K franchise and finishing a degree. One cold email landed $2K in sponsorship. One pattern across interviews rewrote the onboarding.",
