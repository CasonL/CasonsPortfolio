...
const principles = [
  ...
  },
  {
    ...
    body: "Plimsoll orchestrates specialized models for scenario generation, persona simulation, and real-time coaching, all in parallel. No single expensive model. The roleplay is just the input; the output is a precise diagnosis of where a rep needs to improve.",
  ...
  },
  {
    ...
    body: "Ran a $42K franchise solo in 4 months, then built Plimsoll from zero to launch while running a club and finishing a degree. One cold email landed $2K in sponsorship. One pattern across interviews rewrote the onboarding.",
