...
export const metadata: Metadata = {
  ...
  description: "Portfolio of Cason Lamothe: product designer, AI systems architect, and leader building products like Plimsoll, which diagnoses exactly where sales reps lose deals using live AI buyer calls as the input, and an AI resume builder.",
  openGraph: {
